...
#define Deadman_Switch_Pin GPIO_PIN_13
#define Deadman_Switch_GPIO_Port GPIOB
#define emergency_button_critical_security_Pin GPIO_PIN_14
#define emergency_button_critical_security_GPIO_Port GPIOB
...
#define nuke_power_signal_Pin GPIO_PIN_5
#define nuke_power_signal_GPIO_Port GPIOB
